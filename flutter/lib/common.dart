...
class MyTheme {
  ...
  // Brand color: Ruware Desk red
  static const Color accent = Color(0xFF9C1D12);
  static const Color accent50 = Color(0x779C1D12);
  static const Color accent80 = Color(0xAA9C1D12);
  ...
  static const Color button = accent; // use brand color
...
Color? _msgboxColor(String type) {
  ...
  // default info color uses brand accent
